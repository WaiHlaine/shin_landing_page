...
const GlobalPresenceSection = () => {
  ...
  const countries = [
    { key: "japan", flag: "🇯🇵", shops: 2, color: "from-red-500 to-pink-500" },
    { key: "myanmar", flag: "🇲🇲", shops: 3, color: "from-yellow-500 to-green-500" },
    { key: "thailand", flag: "🇹🇭", shops: 2, color: "from-blue-500 to-red-500" },
    { key: "korea", flag: "🇰🇷", shops: 3, color: "from-blue-600 to-red-600" },
    { key: "singapore", flag: "🇸🇬", shops: 4, color: "from-red-600 to-white" },
  ];
